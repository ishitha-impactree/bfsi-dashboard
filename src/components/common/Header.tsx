              ...
              {navigationItems.map((item, index) => (
                <button 
                  ...
                  className={`text-lg font-bold leading-lg text-left transition-all duration-200 ease-in-out transform hover:scale-105 ${
                    item.isActive 
                      ? 'text-header-accent underline' :'text-header-text hover:text-header-accent'
                  } ${
                ...
                >
                  {item.label}
                  {item.isActive && (
                    <div className="hidden lg:block absolute -bottom-2 left-0 w-full h-0.5 bg-header-accent transform scale-x-100 transition-transform duration-200"></div>
                  )}
                </button>
              ))}
            </div>

...
const FormikField: React.FC<FormikFieldProps> = ({
  ...
  return (
    <div style={{ position: 'relative' }}>
      ...
      {isError && (
        <div style={{ color: '#dc3545', fontSize: '0.8rem', marginTop: '4px' }}>{isError}</div>
      )}
    </div>
  );
};
...
const Stack: React.FC<{ direction?: 'horizontal'; className: string; children: ReactNode }> = ({
  children,
}) => (
  <div
    style={{
            ...
            {({ errors, handleSubmit, isSubmitting, setFieldValue, values }) => (
              ...
              >
                <div style={{ textAlign: 'center', marginBottom: '20px' }}>
                  ...
                  <span style={{ color: '#FFB300', fontWeight: 500, fontSize: '1.1rem' }}>

  ...
  return (
    <div className="min-h-screen bg-background">
      <Helmet>
        ...
        <meta
          property="og:title"
          content="Portfolio Analytics | ESG Analytics Platform"
        />
        <meta
          ...
          <div className="flex items-center justify-between">
            <div>
              ...
              <p className="text-md text-muted-foreground mt-1">
                Deep-dive emissions analysis across investment holdings for data-driven sustainable finance decisions
              </p>
            </div>
          </div>
        </div>
      </div>
      <main className="pt-8" style={{ background: '#f8fafc' }}>
        <div className="w-full px-8">
          <div className="rounded-none p-3 sm:p-6 lg:p-3 mb-3 overflow-y-auto">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
              <div className="bg-card border border-border rounded-lg p-6 shadow-elevation-1 hover:shadow-elevation-2 transition-shadow duration-200" style={{ background: 'white' }}>
                ...
                <div className="text-sm text-muted-foreground mb-2">tCO2e/$M revenue</div>
              ...
              <div className="bg-card border border-border rounded-lg p-6 shadow-elevation-1 hover:shadow-elevation-2 transition-shadow duration-200" style={{ background: 'white' }}>
                ...
                <div className="text-sm text-muted-foreground mb-2">of portfolio value</div>
                <div className="flex items-center gap-1 text-success text-sm">
                  <span>↑ 2.1%</span>
              ...
              <div className="bg-card border border-border rounded-lg p-6 shadow-elevation-1 hover:shadow-elevation-2 transition-shadow duration-200" style={{ background: 'white' }}>
                ...
                <div className="text-sm text-muted-foreground mb-2">overall exposure</div>
              ...
              <div className="bg-card border border-border rounded-lg p-6 shadow-elevation-1 hover:shadow-elevation-2 transition-shadow duration-200" style={{ background: 'white' }}>
                ...
                <div className="text-sm text-muted-foreground mb-2">of holdings</div>
                <div className="flex items-center gap-1 text-success text-sm">
                  <span>↑ 8.3%</span>

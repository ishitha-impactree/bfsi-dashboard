...
type SectorType = 'Energy' | 'Materials' | 'Industrials' | 'Technology' | 'Healthcare' | 'Financials';
      ...
      <div className="p-6 border-b border-border">
        <div className="flex items-center justify-between mb-4">
          <div>
            ...
            <p className="text-sm text-muted-foreground">Ranked by portfolio impact</p>
          </div>
      ...
      <div className="p-6">
              ...
              >
                <div className="flex items-start justify-between mb-3">
                  <div className="flex-1 min-w-0">
                    ...
                    <h4 className="font-medium text-foreground text-sm truncate">{emitter.company}</h4>
                    <p className="text-xs text-muted-foreground">{emitter.sector}</p>
                  </div>
                  
                  <div className="text-right">
                    <div className="text-sm font-semibold text-foreground">{emitter.emissions.toFixed(1)}</div>
                ...
                <div className="flex items-center justify-between text-xs">
                  <div className="flex items-center gap-3">
                    <div className="flex items-center gap-1">
                      <Icon 
                        ...
                        size={12} 
                        className={isPositiveTrend ? "text-error" : "text-success"}
                      />
                      <span className={isPositiveTrend ? "text-error" : "text-success"}>
                  ...
                  <div className="text-right">
                    <div className="font-medium text-foreground">{emitter.portfolioImpact.toFixed(1)}%</div>
        ...
        <div className="mt-6 pt-4 border-t border-border">
          <div className="flex items-center justify-between text-sm">
            ...
            <span className="font-semibold text-foreground">{totalPortfolioImpact.toFixed(1)}%</span>
          </div>
        ...
        <div className="mt-4">
          <Button variant="outline" size="sm" className="w-full" iconName="ExternalLink" iconPosition="right" iconSize={14}>
